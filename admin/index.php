...
?>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            $select_all_published_posts = mysqli_query($conn_db_cms, $query);
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            <?php
                                ...
                                $element_count = [$post_count, $post_published_count, $post_draft_count, $comments_count, $disapproved_comment_count, $user_count, $subscriber_count, $categories_count];
                                for($i = 0; $i < 8; $i++){
